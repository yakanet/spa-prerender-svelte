export type Category = {
    ...
    i18n_name?: any[] | CategoryTranslations[] | null;
    id: number;
  ...
  export type MenuMondayBreakfast = {
    id: number;
    produits_id?: string | Produits | null;
    restaurants_id?: number | Restaurants | null;
  };
  
  export type MenuMondayDinner = {
    id: number;
    produits_id?: string | Produits | null;
    restaurants_id?: number | Restaurants | null;
  };
  
  export type MenuMondayLunch = {
    id: number;
    produits_id?: string | Produits | null;
    restaurants_id?: number | Restaurants | null;
  };
  
  export type MenuTuesdayBreakfast = {
    id: number;
    produits_id?: string | Produits | null;
    restaurants_id?: number | Restaurants | null;
  };
  ...
  export type Produits = {
    ...
    date_updated?: string | null;
    energy?: string | null;
    i18n_name?: any[] | ProduitsTranslations[] | null;
    id: string;
    name?: string | null;
    user_created?: string | DirectusUsers | null;
    user_updated?: string | DirectusUsers | null;
  ...
  export type ProduitsTranslations = {
    description?: string | null;
    id: number;
    languages_id?: number | Languages | null;
    name?: string | null;
  ...
  export type Restaurants = {
    ...
    code_affluence?: number | null;
    date_created?: string | null;
    date_updated?: string | null;
    id: number;
    isFree?: boolean | null;
    monday: string;
    monday_breakfast?: any[] | MenuMondayBreakfast[] | null;
    monday_dinner?: any[] | MenuMondayDinner[] | null;
    monday_lunch?: any[] | MenuMondayLunch[] | null;
    name?: string | null;
    ...
    "tabs-kqfgwk": string;
    tuesday: string;
    tuesday_breakfast?: any[] | MenuTuesdayBreakfast[] | null;
    user_created?: string | DirectusUsers | null;
    user_updated?: string | DirectusUsers | null;
  };
  ...
  export type CustomDirectusTypes = {
    ...
    languages: Languages;
    menu_monday_breakfast: MenuMondayBreakfast;
    menu_monday_dinner: MenuMondayDinner;
    menu_monday_lunch: MenuMondayLunch;
    menu_tuesday_breakfast: MenuTuesdayBreakfast;
    produits: Produits;
    produits_translations: ProduitsTranslations;
    qna: Qna;
